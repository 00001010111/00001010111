...
I'm a passionate **Roblox Luau & C programmer** with experience across multiple technologies. I enjoy building games, tools, and solving complex problems through code.  
...
- **Programming Languages:** `Lua (Luau)`, `C`, `C++`, `Python`, `JavaScript`  
- **Game Dev:** `Roblox Studio`  
- **Databases & Backend:** `MySQL`, `Firebase`  
- **Version Control & Collaboration:** `Git`, `GitHub`  
- **Others:** `Docker`, `Linux`, `VS Code`, `CI/CD`  
...
![Commits](https://github-readme-stats.vercel.app/api?username=00001010111&include_all_commits=true&show_icons=true&count_private=true)
![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=00001010111&theme=radical)  

---

## 🌱 Currently Learning
- Advanced **Luau scripting** for Roblox  
...
- [Edgepoint Discord](https://discord.gg/y3GMpDxgJh)
